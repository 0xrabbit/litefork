...
const char * const BITCOIN_CONF_FILENAME = "litefork.conf";
const char * const BITCOIN_PID_FILENAME = "liteforkd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Litefork";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Litefork";
#else
    // Unix
    return pathRet / ".litefork";
#endif
#endif
}
