...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
{
    ...
    bool postfork = nHeight >= params.LFKHeight;
    ...
    else if (nHeight < params.LFKHeight) {
        return nProofOfWorkLimit;
    }
    else if (nHeight < params.LFKHeight  + params.nPowAveragingWindow){
...
unsigned int LitecoinGetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
{
    ...
    // Litefork: This fixes an issue where a 51% attack can change difficulty at will.
