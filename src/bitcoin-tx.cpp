...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s litefork-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  litefork-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded litefork transaction") + "\n" +
              "  litefork-tx [options] -create [commands]   " + _("Create hex-encoded litefork transaction") + "\n" +
              "\n";
